     ...
     stage('Deploy Docker Image to Dockerhub') {
          ...
          stage('Upload jar to Nexus') {
              ...
              stage('Message Mattermost') {
                ...
                mattermostSend channel: '@trophonius, rest-server,town-square', endpoint: 'http://mattermost.itfakultetet.no:8065/hooks/zn9prjnrptn6zxp8jnr3gi61gc', message: "### Bare hyggelig! \n- Jenkins sier:  \nJob:  ${env.JOB_NAME}   \nByggnummer:  ${env.BUILD_NUMBER}  :tada:", text: '### Ny versjon på Nexus og hub.docker.com  :white_check_mark:'
